/**
 * Detect if browser can run autoplay muted video
 * Some browser as ie11 don't return a promise on video.play
 */
export const isAutoplaySupportedOldBrowser = () => {
  ...
  return new Promise((resolve, reject) => {
    ...
    video.oncanplay = () => {
      if (video.isPlaying) {
        ...
        reject(new Error('can\'t play video'))
      }
    }
  })
}
